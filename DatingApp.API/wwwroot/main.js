...
var ListResolver = /** @class */ (function () {
    ...
    ListResolver.prototype.resolve = function (route) {
        ...
        return this.userService
            .getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        ...
        this.photoUrl = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]('../../assets/16.1 user.png.png');
    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
                ...
                var applicationError = error.headers.get('Applcation-Error');
                if (applicationError) {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_error_interceptor__WEBPACK_IMPORTED_MODULE_15__["ErrorInterceptorProvide"],
...
var MemberListComponent = /** @class */ (function () {
    ...
    MemberListComponent.prototype.resetFitlers = function () {
        this.userParams.gender = this.user.gender === 'female' ? 'male' : 'female';
        this.userParams.minAge = 18;
        this.userParams.maxAge = 99;
        this.loadUsers();
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"],
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this message?', function () {
            _this.userService.deleteMessage(id, _this.authService.decodedToken.nameid).subscribe(function () {
                ...
                _this.alertify.success('Message has deleted');
            }, function (error) {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authService.register(this.user).subscribe(function () {
                _this.alertify.success('Reigstration successfully');
            }, function (error) {
                _this.alertify.error(error);
            }, function () {
...
module.exports = __webpack_require__(/*! C:\Users\fahir\documents\datingapp\DatingApp-SPA\src\main.ts */"./src/main.ts");
